...
public class LocationHandler{ // extends BroadcastReceiver {
    ...
    public LocationHandler(Search activity, Context context) {
...
//            promptLocationSettings(context);
            // Try this
            return  false;
//            activity.btn_location_status.setVisibility(View.VISIBLE);
